...
def main(argv):
    ...
    axes[0][0].plot(x, multi_q3_e2,linewidth = 2.5, linestyle = '--',label='PMSJA',
    ...
    axes[0][0].plot(x, r2t_q3_e2,linewidth = 2.5, linestyle = '-.',label='R2T',
    ...
    axes[0][0].plot(x, q3_norm,linewidth = 2.5,linestyle = ':',label='Query result',
    ...
    axes[0][1].plot(x, r2t_q3_e4,linewidth = 2.5, linestyle = '-.',label='R2T',
        marker = 's',markersize = 8,color=plt.cm.tab20c(0),
        markeredgecolor=plt.cm.tab20c(0),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(0))
    axes[0][1].plot(x, multi_q3_e4,linewidth = 2.5, linestyle = '--',label='PMSJA',
        marker = 'v',markersize = 8,color=plt.cm.tab20c(6),
        markeredgecolor=plt.cm.tab20c(6),markeredgewidth = 2,markerfacecolor=plt.cm.tab20c(6))
    axes[0][1].plot(x, q3_norm,linewidth = 2.5,linestyle = ':',label='Query result',
        marker = 'o',markersize = 8,color=plt.cm.tab20c(9),
        markeredgecolor=plt.cm.tab20c(9),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(9))
    axes[0][1].set_yscale('log')
    #axes[0][1].set_title("$\mathbf{Q}_{3}$",fontsize=25, y=1.12)
    axes[0][1].set_xticks([])
    ...
    axes[0][2].plot(x, r2t_q3_e8,linewidth = 2.5, linestyle = '-.',label='R2T',
        marker = 's',markersize = 8,color=plt.cm.tab20c(0),
        markeredgecolor=plt.cm.tab20c(0),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(0))
    axes[0][2].plot(x, multi_q3_e8,linewidth = 2.5, linestyle = '--',label='PMSJA',
        marker = 'v',markersize = 8,color=plt.cm.tab20c(6),
        markeredgecolor=plt.cm.tab20c(6),markeredgewidth = 2,markerfacecolor=plt.cm.tab20c(6))
    axes[0][2].plot(x, q3_norm,linewidth = 2.5,linestyle = ':',label='Query result',
        marker = 'o',markersize = 8,color=plt.cm.tab20c(9),
        markeredgecolor=plt.cm.tab20c(9),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(9))
    ...
    axes[1][0].axhline(y=1000,ls="-",c=plt.cm.tab20c(19))
    axes[1][0].axhline(y=10000,ls="-",c=plt.cm.tab20c(19))
    axes[1][0].axhline(y=1,ls="-",c=plt.cm.tab20c(19))
    axes[1][0].plot(x, r2t_q3_e2_t,linewidth = 2.5, linestyle = '-.',label='R2T',
        marker = 's',markersize = 8,color=plt.cm.tab20c(0),
        markeredgecolor=plt.cm.tab20c(0),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(0))
    axes[1][0].plot(x, multi_q3_e2_t,linewidth = 2.5, linestyle = '--',label='PMSJA',
        marker = 'v',markersize = 8,color=plt.cm.tab20c(6),
        markeredgecolor=plt.cm.tab20c(6),markeredgewidth = 2,markerfacecolor=plt.cm.tab20c(6))
    axes[1][0].plot(x, q3_t,linewidth = 2.5,linestyle = ':',label='Query result',
        marker = 'o',markersize = 8,color=plt.cm.tab20c(9),
        markeredgecolor=plt.cm.tab20c(9),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(9))
    ...
    axes[1][1].axhline(y=10000,ls="-",c=plt.cm.tab20c(19))
    axes[1][1].axhline(y=1000,ls="-",c=plt.cm.tab20c(19))
    axes[1][1].axhline(y=1,ls="-",c=plt.cm.tab20c(19))
    axes[1][1].plot(x, r2t_q3_e4_t,linewidth = 2.5, linestyle = '-.',label='R2T',
        marker = 's',markersize = 8,color=plt.cm.tab20c(0),
        markeredgecolor=plt.cm.tab20c(0),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(0))
    axes[1][1].plot(x, multi_q3_e4_t,linewidth = 2.5, linestyle = '--',label='PMSJA',
        marker = 'v',markersize = 8,color=plt.cm.tab20c(6),
        markeredgecolor=plt.cm.tab20c(6),markeredgewidth = 2,markerfacecolor=plt.cm.tab20c(6))
    axes[1][1].plot(x, q3_t,linewidth = 2.5,linestyle = ':',label='Query result',
        marker = 'o',markersize = 8,color=plt.cm.tab20c(9),
        markeredgecolor=plt.cm.tab20c(9),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(9))
    ...
    axes[1][2].axhline(y=10000,ls="-",c=plt.cm.tab20c(19))
    axes[1][2].axhline(y=1000,ls="-",c=plt.cm.tab20c(19))
    axes[1][2].axhline(y=1,ls="-",c=plt.cm.tab20c(19))
    axes[1][2].plot(x, r2t_q3_e8_t,linewidth = 2.5, linestyle = '-.',label='R2T',
        marker = 's',markersize = 8,color=plt.cm.tab20c(0),
        markeredgecolor=plt.cm.tab20c(0),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(0))
    axes[1][2].plot(x, multi_q3_e8_t,linewidth = 2.5, linestyle = '--',label='PMSJA',
        marker = 'v',markersize = 8,color=plt.cm.tab20c(6),
        markeredgecolor=plt.cm.tab20c(6),markeredgewidth = 2,markerfacecolor=plt.cm.tab20c(6))
    axes[1][2].plot(x, q3_t,linewidth = 2.5,linestyle = ':',label='Query result',
        marker = 'o',markersize = 8,color=plt.cm.tab20c(9),
        markeredgecolor=plt.cm.tab20c(9),markeredgewidth = 1,markerfacecolor=plt.cm.tab20c(9))
    ...
    plt.savefig("../Figure/Scalability1.pdf", bbox_inches='tight')
